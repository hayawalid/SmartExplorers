// ============================================================================
// feed_screen.dart  —  glassmorphic, no gradients, orientation-aware,
//                      dynamic spaces, provider action sheet
//                      ULTRA‑WIDE cards, reduced vertical footprint,
//                      landscape‑optimised layout
// ============================================================================
...
import 'package:mobile_app/screens/shared/chat_screen.dart';
  ...
  Widget _buildHeader({
    ...
    return Padding(
      padding: EdgeInsets.fromLTRB(
          horizontalPadding, headerTop, horizontalPadding, headerBottom),
      child: Row(
        ...
        children: [
          ...
          _ThemeModeToggleButton(
            ...
            onToggled: () => widget.onThemeModeSelected(
  ...
  Widget _buildTabBar({
    ...
    return Padding(
      ...
      child: TabBar(
        ...
        tabs: _tabLabels
            .map((label) =>
                Tab(height: isLandscape ? 30 : null, text: label))
            .toList(),
      ),
    );
  }
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Icon(LucideIcons.sun_medium,
                          size: compact ? 10 : 13,
...
class _SearchBottomSheetState extends State<_SearchBottomSheet> {
  ...
  void initState() {
    ...
    _searchController.addListener(() {
      ...
      _debounce = Timer(
          const Duration(milliseconds: 500), () => _performSearch(newQuery));
    });
  }
  ...
  Future<void> _performSearch(String query) async {
    ...
    try {
      ...
      final all = [
        ...(spaces as List<Map<String, dynamic>>)
            .map((s) => {...s, '_type': 'space'}),
        ...(posts as List<Map<String, dynamic>>)
            .map((p) => {...p, '_type': 'post'}),
        ...(providers)
            .map((p) => {...(p as Map<String, dynamic>), '_type': 'provider'}),
      ];
      if (!mounted) return;
      setState(() {
        _allResults = all.where((item) {
          final title =
              (item['name'] ?? item['full_name'] ?? item['title'] ?? item['caption'] ?? '')
                  .toString()
                  .toLowerCase();
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon:
                          Icon(LucideIcons.search, color: AppDesign.midGrey),
                      suffixIcon: _query.isEmpty
                          ? null
                          : IconButton(
                              onPressed: () => _searchController.clear(),
                              icon:
                                  Icon(LucideIcons.x, color: AppDesign.midGrey),
                            ),
                    ),
                  ),
                ),
                      ...
                      : _allResults.isEmpty && _query.isNotEmpty
                              ...
                              child: Column(
                                ...
                                children: [
                                  Icon(LucideIcons.search_x,
                                      size: 44, color: AppDesign.midGrey),
                          ...
                          : ListView.separated(
                              ...
                              itemBuilder: (context, i) {
                                final item =
                                    _allResults[i] as Map<String, dynamic>;
                                ...
                                if (type == 'space') {
                                  ...
                                  onTap = () => Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (_) => TravelSpaceDetailScreen(
                                            spaceName: title,
                                            memberCount:
                                                item['member_count'] ?? 0,
                                  ...
                                  accent = AppDesign.electricCobalt;
                                  onTap = () => Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (_) =>
...
class _NotificationsBottomSheetState
    extends State<_NotificationsBottomSheet> {
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            timeLabel,
                            style: const TextStyle(
                                fontSize: 12, color: AppDesign.midGrey),
                          ),
                        ],
                      ),
...
class _PostsTabState extends State<_PostsTab> {
      ...
      setState(() {
        _allPosts = data.asMap().entries.map((e) {
          ...
          final media = p['media_url']?.toString() ??
              (p['media_urls'] is List && (p['media_urls'] as List).isNotEmpty
          ...
          return _PostData(
            ...
            author: p['author_name']?.toString() ??
                p['author_username']?.toString() ??
                'Traveler',
            handle: p['author_username'] != null
                ? '@${p['author_username']}'
                : '@traveler',
    ...
    switch (_sortMode) {
      ...
      case _ExploreSortMode.mostRelevant:
        if (currentUserId != null)
          posts.removeWhere((p) => p.authorId == currentUserId);
        posts.sort((a, b) {
  ...
  void _onPostLikeChanged(
      String postId, int newLikes, List<dynamic> newLikesList) {
    setState(() {
  ...
  void _onCommentAdded(String postId, Map<String, dynamic> comment) {
    setState(() {
      final idx = _allPosts.indexWhere((p) => p.id == postId);
      if (idx != -1) {
        final updated = List<dynamic>.from(_allPosts[idx].commentsList)
          ..insert(0, comment);
  ...
  Widget build(BuildContext context) {
    ...
    final isLandscape =
        MediaQuery.of(context).orientation == Orientation.landscape;
    // Wider landscape card width: 95% of screen height (almost full)
    final landscapeCardWidth = MediaQuery.of(context).size.height * 0.95;
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              _SortMenuButton(
                  sortMode: _sortMode, isDark: isDark, onSelected: _applySort),
              ...
              : _posts.isEmpty
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          Icon(LucideIcons.newspaper,
                              size: 48, color: AppDesign.midGrey),
                          const SizedBox(height: 12),
                          const Text('No posts yet',
                              style:
                                  TextStyle(color: AppDesign.midGrey)),
                          const SizedBox(height: 16),
                          FilledButton.icon(
                            onPressed: _openCreatePostPage,
                            ...
                            child: SizedBox(
                              ...
                              child: Padding(
                                ...
                                child: _PostCard(
                                  ...
                                  onLikeChanged: (likes, list) =>
                                      _onPostLikeChanged(
                                          _posts[i].id, likes, list),
                                  onCommentAdded: (c) =>
                                      _onCommentAdded(_posts[i].id, c),
                                ),
                              ),
                            ),
                          );
                        }
                        // Portrait: full width with small margin
                        return Padding(
                          ...
                          child: _PostCard(
                            ...
                            isLandscape: false,
                            onLikeChanged: (likes, list) =>
                                _onPostLikeChanged(_posts[i].id, likes, list),
                            onCommentAdded: (c) =>
                                _onCommentAdded(_posts[i].id, c),
                          ),
                        );
...
class _SortMenuButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return PopupMenuButton<_ExploreSortMode>(
      ...
      itemBuilder: (context) => [
        _popupItem(_ExploreSortMode.oldest,
            sortMode == _ExploreSortMode.oldest, 'Oldest'),
        _popupItem(_ExploreSortMode.mostRecent,
            sortMode == _ExploreSortMode.mostRecent, 'Most recent'),
        _popupItem(_ExploreSortMode.highestInteractions,
            sortMode == _ExploreSortMode.highestInteractions,
            'Highest interactions'),
        _popupItem(_ExploreSortMode.mostRelevant,
            sortMode == _ExploreSortMode.mostRelevant, 'Most relevant'),
      ],
      child: Container(
  ...
  PopupMenuItem<_ExploreSortMode> _popupItem(
      _ExploreSortMode value, bool selected, String label) {
...
class _PostCardState extends State<_PostCard> {
  ...
  Future<void> _toggleLike() async {
    ...
    setState(() {
      ...
      _likesList = _liked
          ? [..._likesList, userId]
          : _likesList.where((id) => id != userId).toList();
      _likes = _likesList.length;
    });
    ...
    try {
      if (_bookmarked) {
        await SocialApiService().saveFavorite({
          ...
          'author_username': widget.post.handle.startsWith('@')
                      ...
                      _ShareOption(
                        ...
                        onTap: () {
                          ...
                          Clipboard.setData(ClipboardData(
                              text:
                                  'smartexplorers://post/${widget.post.id}'));
  ...
  void _showComments() {
    showModalBottomSheet(
      ...
      builder: (ctx) => _CommentsSheet(
        ...
        initialComments: List<Map<String, dynamic>>.from(widget.post.commentsList
            .map((c) => c is Map
  ...
  @override
  Widget build(BuildContext context) {
    // Landscape: show image left + content right (already compact)
    if (widget.isLandscape) {
      return _LandscapePostCard(
        post: widget.post,
        isDark: widget.isDark,
        likes: _likes,
        liked: _liked,
    ...
    // Portrait: reduced vertical footprint (smaller image, tighter margins)
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: widget.isDark
              ? Colors.white.withOpacity(0.05)
              : AppDesign.lightGrey.withOpacity(0.8),
        ),
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: _PostMedia(
                ...
                isDark: widget.isDark,
                height: MediaQuery.of(context).size.width < 430 ? 180 : 220,
              ),
            ),
            Padding(
...
// Landscape variant: image left, caption + comments right, compact
class _LandscapePostCard extends StatelessWidget {
  const _LandscapePostCard({
    required this.post,
    required this.isDark,
    required this.likes,
    required this.liked,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (post.commentsList.isNotEmpty) ...[
                        ...
                        const SizedBox(height: 4),
                        ...post.commentsList.take(2).map((c) {
                          final name = (c is Map
                                  ? (c['author_name'] ?? c['author_username'] ?? 'User')
                                  : 'User')
                              .toString();
                          final txt = (c is Map ? (c['text'] ?? '') : c.toString()).toString();
                          return Padding(
...
class _CommentsSheetState extends State<_CommentsSheet> {
  ...
  Future<void> _sendComment() async {
    ...
    try {
      await SocialApiService().addComment(widget.postId,
          {'author_id': userId, 'text': text, 'author_name': SessionStore.instance.username ?? 'Traveler'});
    } catch (_) {}
  }
                ...
                child: _comments.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (ctx, i) {
                          final c = _comments[i];
                          final authorName =
                              c['author_name'] ?? c['author_username'] ?? 'Traveler';
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Icon(icon,
                size: 20, color: isDark ? Colors.white : AppDesign.eerieBlack),
          ),
          const SizedBox(height: 6),
          Text(label,
              style:
                  const TextStyle(fontSize: 11, color: AppDesign.midGrey)),
        ],
      ),
    );
  }
              ...
              border: Border.all(
                color: active
                    ...
                    : isDark
                        ...
                        : AppDesign.lightGrey.withOpacity(0.7),
              ),
            ),
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Icon(icon, size: compact ? 10 : 14, color: color),
...
class _SpacesTabState extends State<_SpacesTab> {
  ...
  static final _fallbackSpaces = [
    _SpaceData(name: 'Cairo Weekend Explorers', members: 1243, image: 'lib/public/pexels-meryemmeva-34823948.jpg', tag: 'Popular', description: 'Weekend trips and hidden gems around Cairo.'),
    _SpaceData(name: 'Luxor & Upper Egypt', members: 876, image: 'lib/public/smart_itineraries.jpg', tag: 'Active', description: 'Temples, history and Upper Egypt adventures.'),
    _SpaceData(name: 'Red Sea Divers', members: 2100, image: 'lib/public/pexels-zahide-tas-367420941-28406392.jpg', tag: 'Trending', description: 'Snorkeling, diving and Red Sea life.'),
    _SpaceData(name: 'Solo Female Travelers', members: 654, image: 'lib/public/verified_guides.jpg', tag: 'Safe', description: 'Support and tips for women traveling solo.'),
  ];
  ...
  Future<void> _loadSpaces({bool isRefresh = false}) async {
  ...
  Widget build(BuildContext context) {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            const Text('No travel spaces yet',
                style: TextStyle(color: AppDesign.midGrey)),
            const SizedBox(height: 16),
            FilledButton.icon(
              onPressed: () => _loadSpaces(isRefresh: true),
    ...
    return RefreshIndicator(
      onRefresh: () => _loadSpaces(isRefresh: true),
      child: Column(
        children: [
          Padding(
            padding: EdgeInsets.fromLTRB(
                isLandscape ? 20 : 20, 10, isLandscape ? 20 : 20, 8),
            child: Row(
              children: [
                Expanded(
                  child: Text(
...
class _ProvidersTabState extends State<_ProvidersTab> {
  ...
  void _openProviderActionSheet(_ProviderResult provider) {
    HapticFeedback.lightImpact();
    final isDark = Theme.of(context).brightness == Brightness.dark;
    showModalBottomSheet(
      context: context,
      ...
      builder: (ctx) => ClipRRect(
        ...
        child: BackdropFilter(
          ...
          child: Container(
            decoration: BoxDecoration(
              color: isDark
                  ? AppDesign.cardDark.withOpacity(0.96)
                  : Colors.white.withOpacity(0.97),
              borderRadius:
                  const BorderRadius.vertical(top: Radius.circular(28)),
              border: Border.all(
            ...
            child: Column(
              ...
              children: [
                ...
                _Avatar(label: provider.name, size: 52),
                const SizedBox(height: 12),
                Text(
                  provider.name,
                  style: TextStyle(
                ...
                _ProviderActionTile(
                  ...
                  subtitle: 'See services and send a booking request',
                  color: AppDesign.electricCobalt,
                  isDark: isDark,
                  onTap: () {
                    Navigator.pop(ctx);
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        Padding(
          padding: EdgeInsets.fromLTRB(
              isLandscape ? 24 : 20, 10, isLandscape ? 24 : 20, 8),
          child: Row(
            children: [
              Expanded(
                child: Text(
                  ...
                  : providers.isEmpty
                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (context, i) => _ProviderCard(
                            ...
                            isDark: isDark,
                            onTap: () =>
                                _openProviderActionSheet(providers[i]),
                          ),
                        ),
        ),
      ],
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Icon(LucideIcons.chevron_right, size: 18, color: color),
              ],
            ),
          ),
        ),
...
class _ProviderCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final scoreColor = provider.score >= 0.8
        ? AppDesign.success
        : provider.score >= 0.6
            ? AppDesign.warning
            : AppDesign.danger;
              ...
              children: [
                ...
                if (provider.bio.isNotEmpty) ...[
                  ...
                  Text(
                    ...
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                        color: AppDesign.midGrey, height: 1.35),
                  ),
                ],
                const SizedBox(height: 12),
                Row(
...
class _Avatar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      height: size,
      decoration: const BoxDecoration(
          shape: BoxShape.circle, color: AppDesign.electricCobalt),
      child: Center(
        child: Text(
          initial,
          style: TextStyle(
...
class _RequestsTabState extends State<_RequestsTab> {
  ...
  Future<void> _loadBookings() async {
    ...
    try {
      final bookings =
          await _servicesService.getBookings(providerId: providerId);
      setState(() {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (_) => ChatScreen(
          recipientId: req['traveler_id']?.toString() ?? '',
          recipientName: req['traveler_username']?.toString() ?? 'Traveler',
          bookingId: req['_id']?.toString(),
          serviceName: req['service_name']?.toString(),
        ),
      ),
    );
  }
        ...
        child: Column(
          ...
          children: [
            Icon(LucideIcons.triangle_alert,
                size: 48, color: AppDesign.danger),
            const SizedBox(height: 12),
            Text(_error!),
            const SizedBox(height: 24),
            ElevatedButton(
      ...
      child: Column(
        children: [
          TabBar(
            ...
            indicatorColor: AppDesign.electricCobalt,
            labelColor: isDark ? Colors.white : AppDesign.eerieBlack,
            unselectedLabelColor: AppDesign.midGrey,
            dividerColor:
  ...
  Widget _buildList(
      List<Map<String, dynamic>> requests, bool isDark, bool isConfirmed) {
    if (requests.isEmpty) {
      return Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Container(
              ...
              child: Icon(LucideIcons.inbox,
                  size: 28, color: AppDesign.midGrey),
            ),
                    ...
                    Row(
                      children: [
                        const Icon(LucideIcons.calendar,
                            size: 14, color: AppDesign.midGrey),
                        const SizedBox(width: 6),
                        Text(
                          req['booking_date'] ?? '',
                          style: const TextStyle(
                      ...
                      children: [
                        Expanded(
                          child: OutlinedButton(
                            onPressed: _processingId == req['_id']
                                ? null
                                : () => _handleDecline(req),
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        style: OutlinedButton.styleFrom(
                          ...
                          side: BorderSide(
                            color: AppDesign.electricCobalt.withOpacity(0.4),
                          ),
                        ),
                      ),
                    ),
...
class _SpaceData {
  final String name, image, tag, description;
  final int members;
  _SpaceData({
    required this.name,
